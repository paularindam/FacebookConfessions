...
if sys.argv[1] == "posts":
	...
	for uni in comments.keys():
		...
		if category[uni] == 0:
			...
			DOW0, HOD0, MOY0, TOD0, TOW0, TODW0 = getTime(comments,uni,DOW0,HOD0,MOY0,TOD0,TOW0,TODW0)
			allDOW0, allHOD0, allMOY0, allTOD0, allTOW0, allTODW0 = getTime(allComments,uni,allDOW0,allHOD0,allMOY0,allTOD0,allTOW0,allTODW0)
		
		elif category[uni] == 1:
			#numTexts1 += numComments[uni]
			DOW1, HOD1, MOY1, TOD1, TOW1, TODW1 = getTime(comments,uni,DOW1,HOD1,MOY1,TOD1,TOW1,TODW1) 
			allDOW1, allHOD1, allMOY1, allTOD1, allTOW1, allTODW1 = getTime(allComments,uni,allDOW1,allHOD1,allMOY1,allTOD1,allTOW1,allTODW1)
